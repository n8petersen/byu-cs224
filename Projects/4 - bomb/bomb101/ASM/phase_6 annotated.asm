0x401252 <phase_6>      push   %r14                         # $rsp starts at 0x7fffffffe7f8
0x401254 <phase_6+2>    push   %r13
0x401256 <phase_6+4>    push   %r12
0x401258 <phase_6+6>    push   %rbp
0x401259 <phase_6+7>    push   %rbx
0x40125a <phase_6+8>    sub    $0x60,%rsp                   # $rsp set to 0x7fffffe770 which contains 32
0x40125e <phase_6+12>   mov    %fs:0x28,%rax                # sets rax to something
0x401267 <phase_6+21>   mov    %rax,0x58(%rsp)              # puts that something on %rsp+0x58
0x40126c <phase_6+26>   xor    %eax,%eax                    # sets rax to 0
0x40126e <phase_6+28>   mov    %rsp,%rsi                    # moves rsp to rsi (contains 32)
0x401271 <phase_6+31>   callq  0x4017b2 <read_six_numbers>  # reads the 6 input numbers
0x401276 <phase_6+36>   mov    %rsp,%r12                    # moves rsp to r12 (0)
0x401279 <phase_6+39>   mov    %rsp,%r13                    # moves rsp to r12 (0)
...
0x4012bb <phase_6+105>  add    $0x4,%r13                # increments r13, which goes to next input value
...
0x401331 <phase_6+223>  mov    %rdx,%rcx7
